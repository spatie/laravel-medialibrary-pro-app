...
@section('content')
    ...
    <ul class="list-disc list-inside">
        <li><x-list-link route="vue.attachment">Attachment</x-list-link></li>
    ...
    <ul class="list-disc list-inside">
        <li><x-list-link route="react.attachment">Attachment</x-list-link></li>
        <li><x-list-link route="react.async-attachment">Async attachment</x-list-link></li>
    ...
    <ul class="list-disc list-inside">
        <li><x-list-link route="livewire.attachment">Attachment</x-list-link></li>
        <li><x-list-link route="livewire.attachments">Attachments</x-list-link></li>
